...
// Sharp Y0A21 Sensor Map Values
// sensor is good for 5-80cm
...
static int inMap[]  = {  25, 27, 28, 38, 49, 55, 61, 66, 76, 92,104,132,136,139,149,163,176,196,218,246,275,312,364,382,412,452,473,535,555,611};
static int outMap[] = { 150,140,130,120,110,100, 90, 80, 70, 60, 50, 40, 38, 36, 33, 30, 28, 25, 23, 20, 18, 15, 13, 12, 11, 10,  9,  8,  7,  6};

static const int mapSize = 30;

SharpIR_2Y0A21::SharpIR_2Y0A21(int pinNumber)
{
  pin = pinNumber;
  pinMode(pin, INPUT);
...
int SharpIR_2Y0A21::readDistanceCM()
{
...
// for debugging
int SharpIR_2Y0A21::getAvgReading()
{
  return avgReading;
}

int SharpIR_2Y0A21::getMinDist(){
   return outMap[mapSize-2];
}


int SharpIR_2Y0A21::getMaxDist(){
   return outMap[1];
}
